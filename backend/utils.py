...
def search_web(query: str) -> List[Dict]:
    ...
    payload = {"q": query, "location": "India", "gl": "in", "num": 10}
...
def get_place_details(query: str) -> List[Dict]:
    """
    Get place details using Serper.dev Places API

    Args:
        query: The place to search for

    Returns:
        List of places with details including rating and reviews
    """
    print(f"[PLACE SEARCH] Searching for: {query}")

    url = "https://google.serper.dev/places"

    payload = {"q": query, "location": "India", "gl": "in", "num": 5}
